                                                ...
                                                <div class="card-block">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="table-responsive">
                                                                <table class="table  invoice-detail-table">
                                                                    ...
                                                                    <tbody>
                                                                    <?php $total=0; foreach ($DeliveryDetails as $k => $row):
                                                                        if ($row->Releasing_Quantity<>0){?>
                                                                            <tr>
                                                                                <td>
                                                                                    <h6>Pallet Pinewood</h6>

                                                                                </td>
                                                                                <td><?php echo $row->ItemName; ?></td>
                                                                                <td><?php echo $row->Releasing_Quantity; ?> pcs</td>
                                                                                <td><?php echo number_format($row->Price,2); ?></td>
                                                                                <td><?php echo number_format($amount= $row->Releasing_Quantity * $row->Price,2); ?></td>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <p>ACCOUNT NAME : M.A.ENTERPRISES<br>
                                                            BANK NAME : HATTON NATIONAL BANK<br>
                                                            BANK A/C : 069010017897<br>
                                                            BRANCH CODE : 069</p>
                                                        </div>
                                                    </div>
