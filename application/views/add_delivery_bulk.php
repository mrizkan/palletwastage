                                ...
                                <div class="page-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form action="deliverycart" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>Delivery Details for <?php echo $name = $this->session->userdata('Supplier_Name'); ?></h5>
                                                ...
                                                <div class="card-block">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-2">
                                                            <a href="/Delivery/cart_destroy"> <button class="btn btn-danger btn-outline-danger btn-mini"><i class="icofont icofont-eye-alt"></i>Delete all</button></a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered nowrap">
                                                            ...
                                                            <?php foreach ($this->cart->contents() as $items): ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="/Delivery/cart_delete/<?php echo $items['rowid']; ?>"> <button class="btn btn-danger btn-outline-danger btn-icon btn-mini"><i class="ion-close-round"></i></button></a>
                                                                    </td>
                                                                </tr>
                                                                <?php $i++; ?>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-1">
                                                                <a href="/Delivery/delivery_calculation/"> <button class="btn btn-danger"><i class="icofont icofont-check-circled"></i>Update Stores</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
